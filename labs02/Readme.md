...
6. Почему протокол spanning-tree выбрал этот порт в качестве невыделенного (заблокированного) порта? Так как на другой стороне назначенный порта, а не корневой.
